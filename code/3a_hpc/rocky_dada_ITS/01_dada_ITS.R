...
path<- "rocky_dada_ITS/raw" # where the fastq files are located
output <- "rocky_dada_ITS/output" # where we will dump the results//diagnostic
name.run <- "rocky_dada_ITS" # Run name. A directory for the values will be created
