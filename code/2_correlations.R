...
c13 <- c("CUE", "X13maoc", "X13poc", "X13co2", "X13mbc", "X13doc", "X13soc", "co2.native")
...
c13names_24hr <- c("CUE ", a1, a2, a3, a4, a5, a6, a7)
...
a6 <- expression(paste("SO"^"13","C (", mu,"g g"^-1,") "))
a7 <- expression(paste("Priming (", mu,"g g"^-1,") "))
c13names_6mo <- c("CUE ", a1, a2, a3, a4, a5, a6, a7)
...
m2 <- ggplot(cordat9, aes(x = maom.c.g.kg_6mo, y = CUE_6mo, group=Moisture.treatment, size=0.5)) +
  geom_point(alpha=0.7, aes(colour=Residue.type, shape=Moisture.treatment)) +
  geom_smooth(method='lm', se = FALSE, size=1, color="black", aes(linetype=Moisture.treatment)) +
  scale_colour_manual(values=covercols)+
  scale_shape_manual(values=c(19,21))+
...
m1 <- ggplot(cordat9, aes(x = maom.n.g.kg_6mo, y = CUE_6mo, group=Moisture.treatment, size=0.5)) +
  geom_point(alpha=0.7, aes(colour=Residue.type, shape=Moisture.treatment)) +
  geom_smooth(method='lm', se = FALSE, size=1, color="black", aes(linetype=Moisture.treatment)) +
  scale_colour_manual(values=covercols)+
  scale_shape_manual(values=c(19,21))+
...
m3 <- ggplot(cordat9, aes(x = maom.cn_6mo, y = CUE_6mo, group=Moisture.treatment, size=0.5)) +
  geom_point(alpha=0.7, aes(colour=Residue.type, shape=Moisture.treatment)) +
  scale_colour_manual(values=covercols)+
  scale_shape_manual(values=c(19,21))+
  geom_smooth(method='lm', se = FALSE, size=1, color="black", aes(linetype=Moisture.treatment)) +
...
figure <- ggarrange(m1, m2, m3, common.legend = T,
                    labels = c("A", "B", "C"),
                    ncol = 3, nrow = 1)
png("figures/4_correlations/4_corplot_cue_maom.png", width = 3500, height =1200, res=300, units="px")
figure
dev.off()
...
m2 <- ggplot(cordat9, aes(x = pom.c.g.kg_6mo, y = CUE_6mo, group=Moisture.treatment, size=0.5)) +
  geom_point(alpha=0.7, aes(colour=Residue.type, shape=Moisture.treatment)) +
  geom_smooth(method='lm', se = FALSE, size=1, color="black", aes(linetype=Moisture.treatment)) +
  scale_colour_manual(values=covercols)+
  scale_shape_manual(values=c(19,21))+
...
m1 <- ggplot(cordat9, aes(x = pom.n.g.kg_6mo, y = CUE_6mo, group=Moisture.treatment, size=0.5)) +
  geom_point(alpha=0.7, aes(colour=Residue.type, shape=Moisture.treatment)) +
  geom_smooth(method='lm', se = FALSE, size=1, color="black", aes(linetype=Moisture.treatment)) +
  scale_colour_manual(values=covercols)+
  scale_shape_manual(values=c(19,21))+
...
m3 <- ggplot(cordat9, aes(x = pom.cn_6mo, y = CUE_6mo, group=Moisture.treatment, size=0.5)) +
  geom_point(alpha=0.7, aes(colour=Residue.type, shape=Moisture.treatment)) +
  scale_colour_manual(values=covercols)+
  scale_shape_manual(values=c(19,21))+
  geom_smooth(method='lm', se = FALSE, size=1, color="black", aes(linetype=Moisture.treatment)) +
...
figure <- ggarrange(m1, m2, m3, common.legend = T,
                    labels = c("A", "B", "C"),
                    ncol = 3, nrow = 1)
png("figures/4_correlations/4_corplot_cue_pom.png", width = 3500, height =1200, res=300, units="px")
figure
dev.off()
