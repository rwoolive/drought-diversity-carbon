...
ggexport(ggarrange(rcpp, ncol=1, nrow=1), height=4500, width=4500, res=400,
         filename = paste0("Figures/*sequence/ITS_asv abundance curve.png"))
...
write.csv(diversity_dat_ITS, "raw-data/sequence/ITS-diversity.csv")

diversity_dat_ITS2 <- diversity_dat_ITS[,c(1,12:17)]
...
# export
write.csv(dat3, "raw-data/master-dataset-13c_ITS.csv")
...
write.csv(mod.out20, "model-output/*uv/anova_3way_ITS_richness_24 hr.csv")
...
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_richness_24 hr_2-way.csv")
...
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_richness_24 hr_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDE", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_richness_24 hr_2-way_res.csv")
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_ITS_richness_6 mo.csv")
# if glucose not significant, remove from model:
fit <- lme(log(richness) ~ Moisture.treatment*Residue.type, weights=varIdent(form=~1|Moisture.treatment*Residue.type),
           random=~1|Lab.rep, data=dat[which(dat$Harvest.day2=="6 mo"),], na.action="na.omit")
resid <- residuals(fit)
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_richness_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_richness_6 mo_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDE", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_richness_6 mo_2-way_res.csv")
...
fig_richness3 <- p
# export figure
ggpubr::ggexport(fig_richness3, height=1300, width=2600, filename = "figures/*uv/*diversity/1_ITS_richness_2way.png", res = 400)
...
segs <- data.frame(x=rep(1:5,2)-0.3, xend=rep(1:5,2)+0.3,
                   y=testlet_richness_res$response+testlet_richness_res$SE+70, yend=testlet_richness_res$response+testlet_richness_res$SE+70,
...
p <- ggplot(data=testlet_richness, aes(x=Residue.type, y=response, fill=Moisture.treatment)) +
  ...
  geom_text(inherit.aes=FALSE, data=testlet_richness_res,  aes(label=testlet_richness_res$.group, x=rep(1:5, 2), y=testlet_richness_res$response+testlet_richness_res$SE+120))
...
figure
png("figures/*uv/*diversity/1_ITS_richness_2way_b.png", 
...
# fig_richnessb <- p
# # export figure
# ggpubr::ggexport(fig_richnessb, height=1700, width=1700, filename = "figures/*uv/*diversity/1_ITS_richness_2way_b.png", res = 400)
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_ITS_shannon.div_24 hr.csv")
### tukey: 
...
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_shannon.div_24 hr_3-way.csv")
# if glucose not significant, remove from model:
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_shannon.div_24 hr_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_shannon.div_24 hr_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_shannon.div_24 hr_2-way_res.csv")
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_ITS_shannon.div_6 mo.csv")
# if glucose not significant, remove from model:
fit <- lme(log(shannon.div) ~ Moisture.treatment*Residue.type, weights=varIdent(form=~1|Moisture.treatment*Residue.type),
           random=~1|Lab.rep, data=dat[which(dat$Harvest.day2=="6 mo"),], na.action="na.omit")
resid <- residuals(fit)
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_shannon.div_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_shannon.div_6 mo_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_shannon.div_6 mo_2-way_res.csv")
...
fig_shannon.div3 <- p
# export figure
ggpubr::ggexport(fig_shannon.div3, height=1300, width=2600, filename = "figures/*uv/*diversity/1_ITS_shannon.div_2way.png", res = 400)
...
fig_shannon.divb <- p
# export figure
ggpubr::ggexport(fig_shannon.divb, height=1700, width=2700, filename = "figures/*uv/*diversity/1_ITS_shannon.div_2way_b.png", res = 400)
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_ITS_simpson.div_24 hr.csv")
# if glucose not significant, remove from model:
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_simpson.div_24 hr_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_simpson.div_24 hr_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_simpson.div_24 hr_2-way_res.csv")
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_ITS_simpson.div_6 mo.csv")
### tukey: 
...
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_simpson.div_6 mo_3-way.csv")
# if glucose not significant, remove from model:
fit <- lme((simpson.div) ~ Moisture.treatment*Residue.type, weights=varIdent(form=~1|Moisture.treatment*Residue.type),
           random=~1|Lab.rep, data=dat[which(dat$Harvest.day2=="6 mo"),], na.action="na.omit")
resid <- residuals(fit)
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_simpson.div_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_simpson.div_6 mo_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_simpson.div_6 mo_2-way_res.csv")
...
fig_simpson.div3 <- p
# export figure
ggpubr::ggexport(fig_simpson.div3, height=1300, width=2600, filename = "figures/*uv/*diversity/1_ITS_simpson.div_2way.png", res = 400)
...
fig_simpson.divb <- p
# export figure
ggpubr::ggexport(fig_simpson.divb, height=1700, width=2700, filename = "figures/*uv/*diversity/1_ITS_simpson.div_2way_b.png", res = 400)
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_ITS_invsimpson.div_24 hr.csv")
### tukey: 
test1 <- emmeans(fit0, ~Glucose.addition.treatment)
testlet <- cld(test1, type = "response", Letters = "ABCDEFG", reversed = TRUE)
testlet <- testlet[order(testlet$Glucose.addition.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_invsimpson.div_24 hr_3-way.csv")
# if glucose not significant, remove from model:
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_invsimpson.div_24 hr_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_invsimpson.div_24 hr_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_invsimpson.div_24 hr_2-way_res.csv")
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_ITS_invsimpson.div_6 mo.csv")
### tukey: 
test1 <- emmeans(fit0, ~Moisture.treatment*Residue.type*Glucose.addition.treatment)
testlet <- cld(test1, type = "response", Letters = "ABCDEFGHI", reversed = TRUE)
testlet <- testlet[order(testlet$Glucose.addition.treatment, testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_invsimpson.div_6 mo_3-way.csv")
# if glucose not significant, remove from model:
fit <- lme(log(invsimpson.div) ~ Moisture.treatment*Residue.type, weights=varIdent(form=~1|Moisture.treatment*Residue.type),
           random=~1|Lab.rep, data=dat[which(dat$Harvest.day2=="6 mo"),], na.action="na.omit")
resid <- residuals(fit)
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_invsimpson.div_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_invsimpson.div_6 mo_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_invsimpson.div_6 mo_2-way_res.csv")
...
# export figure
ggpubr::ggexport(fig_invsimpson.div3, height=1300, width=2600, filename = "figures/*uv/*diversity/1_ITS_invsimpson.div_2way.png", res = 400)
...
# export figure
ggpubr::ggexport(fig_invsimpson.divb, height=1700, width=2700, filename = "figures/*uv/*diversity/1_ITS_invsimpson.div_2way_b.png", res = 400)
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_ITS_evenness_24 hr.csv")
### tukey: 
test1 <- emmeans(fit0, ~Glucose.addition.treatment)
testlet <- cld(test1, type = "response", Letters = "ABCD", reversed = TRUE)
testlet <- testlet[order(testlet$Glucose.addition.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_evenness_24 hr_3-way.csv")
# if glucose not significant, remove from model:
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_evenness_24 hr_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_evenness_24 hr_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_evenness_24 hr_2-way_res.csv")
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_ITS_evenness_6 mo.csv")
### tukey: 
test1 <- emmeans(fit0, ~Glucose.addition.treatment)
testlet <- cld(test1, type = "response", Letters = "ABCD", reversed = TRUE)
testlet <- testlet[order(testlet$Glucose.addition.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_evenness_6 mo_3-way.csv")
# if glucose not significant, remove from model:
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_evenness_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_evenness_6 mo_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/ITS_evenness_6 mo_2-way_res.csv")
...
fig_evenness3 <- p
# export figure
ggpubr::ggexport(fig_evenness3, height=1300, width=2600, filename = "figures/*uv/*diversity/1_ITS_evenness_2way.png", res = 400)
...
fig_evennessb <- p
# export figure
ggpubr::ggexport(fig_evennessb, height=1700, width=2700, filename = "figures/*uv/*diversity/1_ITS_evenness_2way_b.png", res = 400)




write.csv(mod.anova2, "model-output/*uv/anova_2way_ITS.csv")
