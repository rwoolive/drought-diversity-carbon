...
seqtab.nochim <- seqtab.nochim[,800001:807459]
...
# Write to disk
saveRDS(taxa_0, paste0(output_16S, name, "_tax_assignation_5.rds"))

cat('\n')
cat(paste0('# The obtained taxonomy file can be found in "', paste0(output_16S, name, "_tax_assignation_5.rds"), '"\n'))
cat('\n# All done!\n\n')
