...
#          filename = paste0("Figures/*sequence/16S_asv abundance curve.png"))
...
write.csv(diversity_dat_16S, "raw-data/sequence/16S-diversity.csv")

diversity_dat_16S2 <- diversity_dat_16S[,c(1,12:17)]


# combine diversity data with master incubation data & ITS diversity data
dat <- read.csv("raw-data/master-dataset-13c_ITS.csv")
...
# export
write.csv(dat3, "raw-data/master-dataset-13c_ITS_16S.csv")
...
write.csv(mod.out20, "model-output/*uv/anova_3way_16S_richness.16S_24 hr.csv")
...
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_richness.16S_24 hr_2-way.csv")
...
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_richness.16S_24 hr_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDE", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_richness.16S_24 hr_2-way_res.csv")
...
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_16S_richness.16S_6 mo.csv")
# if glucose not significant, remove from model:
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_richness.16S_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_richness.16S_6 mo_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDE", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_richness.16S_6 mo_2-way_res.csv")
...
p <- ggplot(data=testlet_richness.16S, aes(x=Moisture.treatment, y=response, fill=Residue.type)) +
  ...
  geom_text(aes(label=c(testlet_richness.16S$.group), y=c(rep(2000,20))+c(testlet_richness.16S$response)+c(testlet_richness.16S$SE)), 
...
fig_richness.16S3 <- p
# export figure
ggpubr::ggexport(fig_richness.16S3, height=1300, width=2600, filename = "figures/*uv/*diversity/1_16S_richness.16S_2way.png", res = 400)
...
segs <- data.frame(x=rep(1:5,2)-0.3, xend=rep(1:5,2)+0.3,
                   y=testlet_richness.16S_res$response+testlet_richness.16S_res$SE+3100, yend=testlet_richness.16S_res$response+testlet_richness.16S_res$SE+3100,
...
p <- ggplot(data=testlet_richness.16S, aes(x=Residue.type, y=response, fill=Moisture.treatment)) +
  ...
  geom_text(inherit.aes=FALSE, data=testlet_richness.16S_res,  aes(label=testlet_richness.16S_res$.group, x=rep(1:5, 2), y=testlet_richness.16S_res$response+testlet_richness.16S_res$SE+4700))
...
figure
png("figures/*uv/*diversity/1_16S_richness.16S_2way_b.png", 
...
# fig_richness.16Sb <- p
# # export figure
# ggpubr::ggexport(fig_richness.16Sb, height=1700, width=1700, filename = "figures/*uv/*diversity/1_16S_richness.16S_2way_b.png", res = 400)
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_16S_shannon.div.16S_24 hr.csv")
# if glucose not significant, remove from model:
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_shannon.div.16S_24 hr_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_shannon.div.16S_24 hr_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_shannon.div.16S_24 hr_2-way_res.csv")
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_16S_shannon.div.16S_6 mo.csv")
# if glucose not significant, remove from model:
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_shannon.div.16S_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_shannon.div.16S_6 mo_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_shannon.div.16S_6 mo_2-way_res.csv")
...
# export figure
ggpubr::ggexport(fig_shannon.div.16S3, height=1300, width=2600, filename = "figures/*uv/*diversity/1_16S_shannon.div.16S_2way.png", res = 400)
...
# export figure
ggpubr::ggexport(fig_shannon.div.16Sb, height=1700, width=2700, filename = "figures/*uv/*diversity/1_16S_shannon.div.16S_2way_b.png", res = 400)
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_16S_simpson.div.16S_24 hr.csv")
### tukey: 
...
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_simpson.div.16S_24 hr_3-way.csv")
# if glucose not significant, remove from model:
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_simpson.div.16S_24 hr_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_simpson.div.16S_24 hr_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_simpson.div.16S_24 hr_2-way_res.csv")
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_16S_simpson.div.16S_6 mo.csv")
### tukey: 
test1 <- emmeans(fit0, ~Residue.type*Glucose.addition.treatment)
testlet <- cld(test1, type = "response", Letters = "ABCDEFG", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type,testlet$Glucose.addition.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_simpson.div.16S_6 mo_3-way.csv")
# if glucose not significant, remove from model:
fit <- lme((simpson.div.16S) ~ Moisture.treatment*Residue.type, weights=varIdent(form=~1|Moisture.treatment*Residue.type),
           random=~1|Lab.rep, data=dat[which(dat$Harvest.day2=="6 mo"),], na.action="na.omit")
resid <- residuals(fit)
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_simpson.div.16S_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_simpson.div.16S_6 mo_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_simpson.div.16S_6 mo_2-way_res.csv")
...
# export figure
ggpubr::ggexport(fig_simpson.div.16S3, height=1300, width=2600, filename = "figures/*uv/*diversity/1_16S_simpson.div.16S_2way.png", res = 400)
...
# export figure
ggpubr::ggexport(fig_simpson.div.16Sb, height=1700, width=2700, filename = "figures/*uv/*diversity/1_16S_simpson.div.16S_2way_b.png", res = 400)
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_16S_invsimpson.div.16S_24 hr.csv")
# if glucose not significant, remove from model:
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_invsimpson.div.16S_24 hr_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_invsimpson.div.16S_24 hr_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_invsimpson.div.16S_24 hr_2-way_res.csv")
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_16S_invsimpson.div.16S_6 mo.csv")
### tukey: 
...
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_invsimpson.div.16S_6 mo_3-way.csv")
# if glucose not significant, remove from model:
fit <- lme(log(invsimpson.div.16S) ~ Moisture.treatment*Residue.type, weights=varIdent(form=~1|Moisture.treatment*Residue.type),
           random=~1|Lab.rep/Glucose.addition.treatment, data=dat[which(dat$Harvest.day2=="6 mo"),], na.action="na.omit")
resid <- residuals(fit)
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_invsimpson.div.16S_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_invsimpson.div.16S_6 mo_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_invsimpson.div.16S_6 mo_2-way_res.csv")
...
# export figure
ggpubr::ggexport(fig_invsimpson.div.16S3, height=1300, width=2600, filename = "figures/*uv/*diversity/1_16S_invsimpson.div.16S_2way.png", res = 400)
...
# export figure
ggpubr::ggexport(fig_invsimpson.div.16Sb, height=1700, width=2700, filename = "figures/*uv/*diversity/1_16S_invsimpson.div.16S_2way_b.png", res = 400)
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_16S_evenness.16S_24 hr.csv")
### tukey: 
test1 <- emmeans(fit0, ~Residue.type*Glucose.addition.treatment)
testlet <- cld(test1, type = "response", Letters = "ABCDEFG", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type, testlet$Glucose.addition.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_evenness.16S_24 hr_3-way.csv")
# if glucose not significant, remove from model:
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_evenness.16S_24 hr_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_evenness.16S_24 hr_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_evenness.16S_24 hr_2-way_res.csv")
...
mod.out0 <- as.data.frame(car::Anova(fit0)) # default SS for Anova is type-III
mod.out20 <- mod.out0 %>% mutate_if(is.numeric, round, digits=3)
write.csv(mod.out20, "model-output/*uv/anova_3way_16S_evenness.16S_6 mo.csv")
### tukey: 
...
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_evenness.16S_6 mo_3-way.csv")
# if glucose not significant, remove from model:
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_evenness.16S_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_evenness.16S_6 mo_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDEF", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/*diversity/16S_evenness.16S_6 mo_2-way_res.csv")
...
fig_evenness.16S3 <- p
# export figure
ggpubr::ggexport(fig_evenness.16S3, height=1300, width=2600, filename = "figures/*uv/*diversity/1_16S_evenness.16S_2way.png", res = 400)
...
fig_evenness.16Sb <- p
# export figure
ggpubr::ggexport(fig_evenness.16Sb, height=1700, width=2700, filename = "figures/*uv/*diversity/1_16S_evenness.16S_2way_b.png", res = 400)




write.csv(mod.anova2, "model-output/*uv/anova_2way_16S.csv")
