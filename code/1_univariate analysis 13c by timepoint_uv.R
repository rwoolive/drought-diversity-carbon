...
write.csv(testlet, "model-output/*uv/lsmeans/CUE_24 hr_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/CUE_6 mo_2-way.csv")
...
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/CUE_6 mo_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDE", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/CUE_6 mo_2-way_res.csv")
...
fig_CUE3 <- p
# export figure
ggpubr::ggexport(fig_CUE3, height=1300, width=2600, filename = "figures/*uv/1_cue_2way.png", res = 400)
...
fig_CUEb <- p
# export figure
ggpubr::ggexport(fig_CUEb, height=1700, width=2700, filename = "figures/*uv/1_cue_2way_b.png", res = 400)
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/co2.native_24 hr_2-way.csv")
...
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/co2.native_24 hr_2-way_res.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/co2.native_24 hr_2-way_mois.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/co2.native_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/co2.native_6 mo_2-way_res.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/co2.native_6 mo_2-way_mois.csv")
...
fig_co2.native3 <- p
# export figure
ggpubr::ggexport(fig_co2.native3, height=1500, width=2500, filename = "figures/*uv/co2.native_2way.png", res = 400)
...
# plot
testlet_co2.native_res$y_position <- c(rep(0, 5), rep(0, 5)) + testlet_co2.native_res$response + testlet_co2.native_res$SE
segs <- data.frame(x=rep(1:5,1)-0.3, xend=rep(1:5,2)+0.3,
                   y=c(2,4,10,10,10)-0.7, yend=c(2,4,10,10,10)-0.7,
                   Harvest.day2="24 hr")
...
p <- ggplot(data=testlet_co2.native, aes(x=Residue.type, y=response, fill=Moisture.treatment)) +
  ...
  geom_text(inherit.aes=FALSE, data=testlet_co2.native_res,size=2,
            aes(label=c(testlet_co2.native_res$.group[1:5],rep(NA,5)), x= rep(1:5,2), y=c(2,4,10,10,10, rep(0,5)))) +
...
fig_co2.native3b <- p
# export figure
ggpubr::ggexport(fig_co2.native3b, height=1800, width=2500, filename = "figures/*uv/co2.native_2wayb.png", res = 400)
...
ggpubr::ggexport(fig, height=2500, width=2500, 
         filename = "figures/*uv/1_cue and co2.native_2way.png", res = 400)
...
ggpubr::ggexport(fig, height=2500, width=2500, 
                 filename = "figures/*uv/1_cue and co2.native_2wayb.png", res = 400)
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13maoc_24 hr_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13maoc_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13maoc_6 mo_2-way_res.csv")
...
fig_X13maoc3 <- p
# export figure
ggpubr::ggexport(fig_X13maoc3, height=1000, width=2500, filename = "figures/*uv/X13maoc_2way.png", res = 400)
...
fig_X13maoc3b <- p
# export figure
ggpubr::ggexport(fig_X13maoc3b, height=1600, width=2500, filename = "figures/*uv/X13maoc_2way.png", res = 400)
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13co2_24 hr_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13co2_24 hr_2-way_mois.csv")
### tukey: 
test1 <- emmeans(fit, ~Residue.type)
testlet <- cld(test1, type = "response", Letters = "ABCDE", reversed = TRUE)
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13co2_24 hr_2-way_res.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13co2_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13co2_6 mo_2-way_res.csv")
...
fig_X13co23 <- p
# export figure
ggpubr::ggexport(fig_X13co23, height=1000, width=2500, filename = "figures/*uv/X13co2_2way.png", res = 400)
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13poc_24 hr_2-way.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13poc_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13poc_6 mo_2-way_res.csv")
...
fig_X13poc3 <- p
# export figure
ggpubr::ggexport(fig_X13poc3, height=1000, width=2500, filename = "figures/*uv/X13poc_2way.png", res = 400)
 ...
 testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/X13mbc_24 hr_2-way.csv")
 ...
 testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/X13mbc_6 mo_2-way.csv")
 ...
 fig_X13mbc3 <- p
 # export figure
 ggpubr::ggexport(fig_X13mbc3, height=1000, width=2500, filename = "figures/*uv/X13mbc_2way.png", res = 400)
 ...
 testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/X13doc_24 hr_2-way.csv")
 ...
 testlet <- testlet[order(testlet$Moisture.treatment),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/X13doc_24 hr_2-way_mois.csv")
 ### tukey: 
 test1 <- emmeans(fit, ~Residue.type)
 testlet <- cld(test1, type = "response", Letters = "ABCDE", reversed = TRUE)
 testlet <- testlet[order(testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/X13doc_24 hr_2-way_res.csv")
 ...
 testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/X13doc_6 mo_2-way.csv")
 ...
 testlet <- testlet[order(testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/X13doc_6 mo_2-way_res.csv")
 ...
 fig_X13doc3 <- p
 # export figure
 ggpubr::ggexport(fig_X13doc3, height=1000, width=2500, filename = "figures/*uv/X13doc_2way.png", res = 400)
...
stacked_fig
ggpubr::ggexport(stacked_fig, height=2000, width=4000, filename = "figures/*uv/2a_stacked.png", res = 400)
...
ggpubr::ggexport(stacked_fig_b, height=2000, width=5000, filename = "figures/*uv/2a_stacked_b.png", res = 400)
...
stacked_fig
ggpubr::ggexport(stacked_fig, height=1700, width=4000, filename = "figures/*uv/2a-2_stacked.png", res = 400)
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13soc_24 hr_2-way.csv")
...
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13soc_24 hr_2-way_res.csv")
...
testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13soc_6 mo_2-way.csv")
...
testlet <- testlet[order(testlet$Residue.type),]
testlet$.group <- gsub(" ", "", testlet$.group)
write.csv(testlet, "model-output/*uv/lsmeans/X13soc_6 mo_2-way_res.csv")
...
fig_X13soc3 <- p
# export figure
ggpubr::ggexport(fig_X13soc3, height=1000, width=2500, filename = "figures/*uv/X13soc_2way.png", res = 400)
...
stacked_fig_c
ggpubr::ggexport(stacked_fig_c, height=2000, width=4000, filename = "figures/*uv/2c_stacked.png", res = 400)
...
####### m1_3pool
 ...
 testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/m1_3pool_2-way.csv")
 ...
 testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/m2_3pool_2-way.csv")
 ...
 testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/m3_3pool_2-way.csv")
 ...
 ggpubr::ggexport(fig, height=1100, width=5000, filename = "figures/*uv/5c_barplot-sizes.png", res = 400)
 ...
 testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/k1_3pool_2-way.csv")
 ...
 testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/k2_3pool_2-way.csv")
 ...
 testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/k3_3pool_2-way.csv")
 ...
 testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/maom.cn.change_24 hr_2-way.csv")
 ...
 testlet <- testlet[order(testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/maom.cn.change_24 hr_2-way_res.csv")
 ...
 testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/maom.cn.change_6 mo_2-way.csv")
 ...
 testlet <- testlet[order(testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/maom.cn.change_6 mo_2-way_res.csv")
 ...
 # export figure
 ggpubr::ggexport(fig_maom.cn.change3, height=1700, width=2500, filename = "figures/*uv/maom.cn.change_2way.png", res = 400)
 ...
 testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/pom.cn.change_24 hr_2-way.csv")
 ...
 testlet <- testlet[order(testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/pom.cn.change_24 hr_2-way_res.csv")
 ...
 testlet <- testlet[order(testlet$Moisture.treatment, testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/pom.cn.change_6 mo_2-way.csv")
 ...
 testlet <- testlet[order( testlet$Residue.type),]
 testlet$.group <- gsub(" ", "", testlet$.group)
 write.csv(testlet, "model-output/*uv/lsmeans/pom.cn.change_6 mo_2-way_res.csv")
 ...
 # export figure
 ggpubr::ggexport(fig_pom.cn.change3, height=1700, width=2500, filename = "figures/*uv/pom.cn.change_2way.png", res = 400)
...
write.csv(mod.anova2, "model-output/*uv/anova_2way.csv")
